...
const jwt_auth_guard_1 = require("../../../utils/guards/jwt.auth.guard");
const local_auth_guards_1 = require("../../../utils/guards/local-auth.guards");
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(roles_enum_1.Role.CORDINATOR),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Object)
], AuthController.prototype, "getResponse", null);
